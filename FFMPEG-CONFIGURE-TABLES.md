# [Archiv8][a8]![External Link][ext-link_h1] FFmpeg Configuration Options
...
ross@whatido ~/Downloads/Source Code/FFmpeg-n5.0 % ./configure --help
Usage: configure [options]
Options: [defaults in brackets after descriptions]

### Help options

|  Option                   |  Description                                   |  FFmpeg Default |
|  :---                     |  :---                                          |  :---           |
|  --help                   |  print this message                            |  N/A            |
|  --quiet                  |  Suppress showing informative output           |  N/A            |
|  --list-decoders          |  show all available decoders                   |  N/A            |
|  --list-encoders          |  show all available encoders                   |  N/A            |
|  --list-hwaccels          |  show all available hardware accelerators      |  N/A            |
|  --list-demuxers          |  show all available demuxers                   |  N/A            |
|  --list-muxers            |  show all available muxers                     |  N/A            |
|  --list-parsers           |  show all available parsers                    |  N/A            |
|  --list-protocols         |  show all available protocols                  |  N/A            |
|  --list-bsfs              |  show all available bitstream filters          |  N/A            |
|  --list-indevs            |  show all available input devices              |  N/A            |
|  --list-outdevs           |  show all available output devices             |  N/A            |
|  --list-filters           |  show all available filters                    |  N/A            |
...
|  --disable-logging        |  do not log configure debug information        |  N/A                    |
|  --fatal-warnings         |  fail if any configure warning is generated    |  N/A                    |
...
|  --enable-rpath           |  use rpath to allow installing libraries in paths not part of the dynamic linker search path. Use rpath when linking programs (USE WITH CARE)  | N/A            |
|  --install-name-dir=DIR   |  Darwin directory name for installed targets   | N/A                     |
